...
| M8–M11 | Fill in the 13 required v5 fields for `markdown-post-frontmatter-review` | Why each field exists and what it commits you to |
...
## M8–M11: Fill in the 13 required v5 fields

The 13 required v5 fields are: `schema_version`, `name`, `description`, `version`, `type`, `category`, `scope`, `owner`, `freshness`, `drift_check`, `eval_artifacts`, `eval_state`, `routing_eval`. The template has all 13 — you're replacing values, not adding fields.
